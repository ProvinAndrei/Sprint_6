...
class MainPageLocators:  # Локаторы главной страницы
    ...
    ORDER_BUTTON_HEAD = By.XPATH, "//div[contains(@class, 'Header_Nav')]"
    "/button[text()='Заказать']"

    # Кнопка заказать по средине страницы
    ORDER_BUTTON_HOME = By.XPATH, "//div[contains(@class, 'Home')]"
    "/button[text()='Заказать']"
...
# Ответы на вопросы #accordion__panel-0
